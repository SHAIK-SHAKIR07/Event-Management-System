...
//       {[
//         { color: '#4285F4', path: 'M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z', fill: 'currentColor' },
//       ].map((_, i) => (
//         <motion.a key={i} href="#"
//           whileHover={{ y: -3, boxShadow: '0 5px 15px rgba(0,0,0,0.1)' }}
//           className="w-11 h-11 flex items-center justify-center border border-gray-200 rounded-full text-indigo-500 hover:border-indigo-400 transition cursor-pointer">
//           {i === 0 && (
...
// Add 3 icons manually
function SocialIconsRow() {
  return (
    <div className="flex justify-center gap-4 mt-2">
      <motion.a href="#" whileHover={{ y: -3 }} className="w-11 h-11 flex items-center justify-center border border-gray-200 rounded-full cursor-pointer hover:border-indigo-400 transition">
        <svg width="18" height="18" viewBox="0 0 24 24">
          <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/>
          <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/>
          <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"/>
  ...
  return (
    <>
      <style>{`
        ...
        .input-field input::placeholder { color: #aaa; font-weight: 400; }
        .auth-btn {
          width: 150px;
        ...
        .panel h3 { font-size: 1.5rem; font-weight: 700; margin-bottom: 10px; }
        .panel p { font-size: 0.95rem; padding: 0.7rem 0; opacity: 0.9; }
        .transparent-btn {
          background: none;
        ...
        .social-text { color: #888; font-size: 0.9rem; margin: 8px 0 4px; }
        @media (max-width: 768px) {
          .auth-container { min-height: 750px; }
          .signin-signup {
            width: 100%;
            top: 95%;
          ...
          .panel { flex-direction: row; justify-content: space-around; padding: 2rem 8%; grid-column: 1/2; }
          ...
          <div className="forms-container">
            <div className="signin-signup">
              ...
              <form className="auth-form sign-in-form" onSubmit={handleLogin}>
                ...
                {error && (
                  <p className="text-red-500 text-sm bg-red-50 px-4 py-2 rounded-lg mb-2">{error}</p>
                )}
          ...
          <div className="panels-container">
            <div className="panel left-panel">
              <div className="content">
                <h3>New to EventHub?</h3>
                <p>Join thousands of event lovers. Create your free account and start discovering amazing events!</p>
                <button className="transparent-btn" onClick={() => setIsSignUp(true)}>
                  Sign Up
                </button>
              </div>
            </div>
            <div className="panel right-panel">
              <div className="content">
                ...
                <p>Welcome back! Sign in to manage your tickets and discover new events near you.</p>
                <button className="transparent-btn" onClick={() => setIsSignUp(false)}>
                  Sign In
                </button>
              </div>
            </div>
